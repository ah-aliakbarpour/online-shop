            ...
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto">
                    <div class="about-image-wrap mt-md-26 mt-sm-26">
                        <img src="{{ asset('template_main/assets/img/about/about.jpg') }}" alt="About" />
                    </div>
                </div>
                <!-- About Image End -->
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-30">
                        <div class="team-thumb img-full">
                            <img src="{{ asset('template_main/assets/img/team/team_member_1.jpg') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-30">
                        <div class="team-thumb img-full">
                            <img src="{{ asset('template_main/assets/img/team/team_member_2.jpg') }}" alt="">
                            <div class="team-social">
                                <a href=""><i class="fa fa-facebook"></i></a>
                                <a href=""><i class="fa fa-twitter"></i></a>
                                <a href=""><i class="fa fa-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-30">
                        <div class="team-thumb img-full">
                            <img src="{{ asset('template_main/assets/img/team/team_member_4.jpg') }}" alt="">
                            <div class="team-social">
                                <a href=""><i class="fa fa-facebook"></i></a>
                                <a href=""><i class="fa fa-twitter"></i></a>
                                <a href=""><i class="fa fa-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-30">
                        <div class="team-thumb img-full">
                            <img src="{{ asset('template_main/assets/img/team/team_member_3.jpg') }}" alt="">
                            <div class="team-social">
                                <a href=""><i class="fa fa-facebook"></i></a>
                                <a href=""><i class="fa fa-twitter"></i></a>
                                <a href=""><i class="fa fa-linkedin"></i></a>
                    ...
                    <div class="testimonial-carousel-active testimonial-style-2 slick-dot-style">
                        <div class="testimonial-item text-center">
                            <div class="testimonial-thumb">
                                <img src="{{ asset('template_main/assets/img/testimonial/team_member1.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="testimonial-item text-center">
                            <div class="testimonial-thumb">
                                <img src="{{ asset('template_main/assets/img/testimonial/team_member2.jpg') }}" alt="">
                            </div>
                            <div class="testimonial-content">
                                <p>Etiam rhoncus congue arcu sed interdum. Cras dolor diam, accumsan eu aliquam eu, luctus vehicula velit. Nam eget tortor ut felis fermentum sodales ac eu lacus</p>
                                <h3><a href="">Elizabeth Taylor</a></h3>
                        ...
                        <div class="testimonial-item text-center">
                            <div class="testimonial-thumb">
                                <img src="{{ asset('template_main/assets/img/testimonial/team_member3.jpg') }}" alt="">
                            </div>
                            <div class="testimonial-content">
                                <p>Etiam rhoncus congue arcu sed interdum. Cras dolor diam, accumsan eu aliquam eu, luctus vehicula velit. Nam eget tortor ut felis fermentum sodales ac eu lacus</p>
                                <h3><a href="">Elizabeth Taylor</a></h3>
