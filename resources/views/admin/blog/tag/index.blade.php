...
@section('content-header', 'Blog Tags')
                    ...
                    @else
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th colspan="9">
                                    <form id="selections" action="{{ route('admin.blog.tag.selections') }}" method="post">
                                        @csrf
                            ...
                            @foreach($tags as $tag)
                                <tr>
                                    ...
                                    <td style="padding-top: 5px;">
                                        <a href="{{ route('admin.blog.tag.edit', ['tag' => $tag->id]) }}"
                                            class="btn btn-success btn-sm" style="margin-top: 3px;">Edit</a>
                                        <form action="{{ route('admin.blog.tag.destroy', ['tag' => $tag->id]) }}"
