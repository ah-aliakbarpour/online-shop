                    ...
                    @else
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th colspan="9">
                                    <form id="selections" action="{{ route('admin.product.category.selections') }}" method="post">
                                        @csrf
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td style="padding-top: 5px;">
                                            <a href="{{ route('admin.product.category.edit', ['category' => $category->id]) }}"
                                                class="btn btn-success btn-sm" style="margin-top: 3px;">Edit</a>
                                            <form action="{{ route('admin.product.category.destroy', ['category' => $category->id]) }}"
