...
(function ($) {
	...
	// mini cart toggler
	$(".mini-cart-dropdown-toggle").on("click", function (event) {
	...
	var rangeSlider = $(".price-range"),
        ...
        inputMinPrice = rangeSlider.data('input_min'), // Initial value
        inputMaxPrice = rangeSlider.data('input_max'); // Initial value
	rangeSlider.slider({
		range: true,
		min: minPrice,
		max: maxPrice,
		values: [inputMinPrice, inputMaxPrice],
